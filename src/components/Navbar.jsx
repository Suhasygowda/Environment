...
// // // //             <button
// // // //               onClick={() => navigate("/")}
// // // //               className="flex items-center gap-2 text-[#0B2418] font-bold text-2xl hover:text-[#86CA6B] transition cursor-pointer"
// // // //             >
...
//     } ${
//       scrolled 
//         ? 'bg-[#F5FBF2] shadow-lg border-b border-gray-200' 
//         : 'bg-transparent'
//     }`}>
...
//             <span className="text-lg sm:text-2xl">Treepedia</span>
//           </button>
