...
const Cards = () => {
  return (
    <section className="w-full bg-[#F5FBF2] py-10 sm:py-16 md:py-20">

      {/* CLEAN HEADING */}
      <h2 className="text-center text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[#0B2418] mb-8 sm:mb-10 md:mb-14 px-4">
        Explore Nature's <span className="text-[#86CA6B]">Beauty</span>
      </h2>

      <div className="max-w-7xl mx-auto px-4 sm:px-6 grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10 md:gap-12 items-center">
        ...
        <div className="space-y-4 sm:space-y-5 md:space-y-6">
          <h3 className="text-xl sm:text-2xl md:text-3xl font-semibold text-[#0B2418]">
            A Living Gallery of Trees
          </h3>

          <p className="text-base sm:text-lg text-[#355D43] leading-relaxed">
            Treepedia brings you closer to the world of trees through a visually immersive experience. 
            Each image tells a story of strength, preservation, and natural harmony — from ancient forest 
            canopies to rare botanical treasures.
          </p>

          <p className="text-base sm:text-lg text-[#4F7F65] leading-relaxed">
            Discover how these trees support biodiversity, improve air quality, and contribute to 
            sustainable ecosystems while learning their cultural and medicinal significance.
          </p>
        </div>
    ...
    >
      ...
      >
        {images.map((image, index) => (
          <SwiperSlide key={index}>
            <img
              className="h-full w-full scale-105 rounded-2xl sm:rounded-3xl object-cover"
              src={image.src}
              alt={image.alt}
            />
          </SwiperSlide>
