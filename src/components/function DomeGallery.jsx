...
const TREEPEDIA_IMAGES = [
  {
    src: "https://images.unsplash.com/photo-1724754413206-8592feff56dc?q=80&w=880&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    alt: "Tree species 1"
  },
  {
    src: "https://images.unsplash.com/photo-1506953823976-52e1fdc0149a?q=80&w=735&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    alt: "Tree species 2"
  },
  {
    src: "https://plus.unsplash.com/premium_photo-1688124010168-659d723bf6c1?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    alt: "Tree species 3"
  },
  {
  ...
  {
    src: "https://images.unsplash.com/photo-1758552218995-2cc6b581d0ce?q=80&w=694&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    alt: "Tree species 10"
  }
];
...
function buildItems(pool, seg) {
  ...
  if (pool.length > totalSlots) {
    console.warn(
      `[TreepediaDomeGallery] Provided image count (${pool.length}) exceeds available tiles (${totalSlots}). Some images will not be shown.`
    );
  }
...
export default function TreepediaDomeGallery({
  images = TREEPEDIA_IMAGES,
  fit = 0.5,
  fitBasis = 'auto',
  minRadius = 400,
  maxRadius = Infinity,
  padFactor = 0.25,
  overlayBlurColor = '#F5FBF2',
  maxVerticalRotationDeg = DEFAULTS.maxVerticalRotationDeg,
  dragSensitivity = DEFAULTS.dragSensitivity,
  enlargeTransitionMs = DEFAULTS.enlargeTransitionMs,
  segments = DEFAULTS.segments,
  ...
  const cssStyles = `
    ...
    .item__image {
      ...
      -webkit-transform: translateZ(0);
      transform: translateZ(0);
      box-shadow: 0 4px 12px rgba(11, 36, 24, 0.1);
    }
    
    .item__image:hover {
      box-shadow: 0 8px 20px rgba(134, 202, 107, 0.2);
    }
  ...
  return (
    <>
      ...
      <div
        ref={rootRef}
        className="sphere-root relative w-full h-full bg-[#F5FBF2]"
        style={{
          ['--segments-x']: segments,
          ['--segments-y']: segments,
          ['--overlay-blur-color']: overlayBlurColor,
      ...
      >
        ...
        >
          ...
          <div
            className="absolute left-0 right-0 top-0 h-[80px] sm:h-[100px] lg:h-[120px] z-[5] pointer-events-none rotate-180"
            style={{
              background: `linear-gradient(to bottom, transparent, var(--overlay-blur-color, ${overlayBlurColor}))`
            }}
          />
          <div
            className="absolute left-0 right-0 bottom-0 h-[80px] sm:h-[100px] lg:h-[120px] z-[5] pointer-events-none"
            style={{
              background: `linear-gradient(to bottom, transparent, var(--overlay-blur-color, ${overlayBlurColor}))`
            }}
          />
